...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
  <!-- Brand -->
  <a class="navbar-brand" href="index.php">Check Out</a>
...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="jumbotron p-3 mb-2 text-center">
            ...
            <h6 class="lead"><b>Delivery Fees: </b>Free</h6>
        ...
        <form action="" method="post" id="placeOrder">
            ...
            <div class="form-group">
                <input type="tel" name="phone" class="form-control" placeholder="Enter Your HP" required>

            </div>
            <div class="form-group">
                <textarea name="address" class="form-control" cols="5" rows="10" placeholder="Enter Delivery Address Right Here..."></textarea>
            </div>
            <div class="form-group">
            ...
            <select name="pmode" class="form-control">
                ...
                <option value="cod">Online Banking</option>
